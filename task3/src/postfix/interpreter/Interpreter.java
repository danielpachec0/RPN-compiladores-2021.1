...
public class Interpreter implements Expr.Visitor<Integer> {
	...
	public final HashMap<String, String> hash_map;

	public Interpreter(HashMap<String, String> hash_map){
	...
	public Integer visitIDExpr(Expr.ID expr) {
		String idValue = this.hash_map.get(expr.value);

		if(idValue!=null){
			return Integer.parseInt(idValue);
		}else{
			throw new InterpError(expr.value + " cannot be resolved");
		}
	}
